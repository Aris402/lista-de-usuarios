...
const AllTasks = (props: any) => {
    ...
    const [tasks, setTasks] = useState([
		{ userId: "1", id: "1", title: "Ensinar React", completed: false },
		{ userId: "2", id: "2", title: "Ensinar Javascrept", completed: true }
	])
    ...
    return (
        <div className="alignMent">
				<h1 className='header-user'>Lista de todas as tarefas</h1>
				<div className="tasks">
